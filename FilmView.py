...
class FilmView (QWidget):
    ...
    def __init__(self : Self, record : dict) -> None:
        ...
        self.setStyleSheet('background-color : #0C1A25 ;color : white')
        ...
        self.info1Widget.setStyleSheet('border: solid;border-color: red;') 
        ...
        self.title.setStyleSheet('font-weight: bold;background-color:#193549')
        self.topLayouyt.addWidget(self.title)
        ...
        self.previousButton.setStyleSheet('background-color: #5B6668')
        self.msg : QLabel = QLabel('---- information message ---')
        self.nextButton : QPushButton = QPushButton('>>')
        self.nextButton.setStyleSheet('background-color: #5B6668')
    ...
    # methods
    def update(self : Self, record : dict, genres : list[str], distributors : list[str],licenses : list[str]) -> None:
...
if __name__ == "__main__" :
    ...
    db.loadCSV()
    fv = FilmView({})
    fv.update(db.db[0],db.genres, db.distributors, db.licences)
    sys.exit(app.exec())
