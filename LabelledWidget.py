...
class LabelledWidget (QWidget):
    ...
    def __init__(self : Self, info:str, 
        ...
        # gui
        self.topLayout : Union[QVBoxLayout,QHBoxLayout] = QVBoxLayout()  if  orientation == Qt.Orientation.Vertical else  QHBoxLayout()  ; self.setLayout(self.topLayout)
        # label
